<h1>2266 - Minimum Cost to Set Cooking Time</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-cost-to-set-cooking-time/">minimum-cost-to-set-cooking-time</a></h2><p>A generic microwave supports cooking times for:</p>
